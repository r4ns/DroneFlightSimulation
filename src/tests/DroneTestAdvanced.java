...
public class DroneTestAdvanced {
	...
	public void testMoveToDestination() {
		...
		String expectedOutput = "Drone position : (" + Integer.toString(destinationCoordinates[0]) + ","
				+ Integer.toString(destinationCoordinates[1]) + "," + Integer.toString(destinationCoordinates[2]) + ")";
